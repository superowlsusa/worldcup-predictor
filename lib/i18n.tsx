...
const en: Dict = {
  ...
  'rules.koBody': 'When the knockout matchups are known, the teams are filled in automatically. Players can then make new selections for those fixtures until the one-hour lock.',
...
const es: Dict = {
  ...
  'rules.koBody': 'Cuando se conocen los cruces eliminatorios, los equipos se completan automáticamente. Los jugadores pueden entonces hacer nuevas predicciones para esos partidos hasta el bloqueo de una hora.',
