...
const en: Dict = {
  ...
  'fx.changeHint': 'You can change your prediction until this stage’s first match kicks off.',
  'fx.lockNote': 'Predictions lock when this stage’s first match kicks off.',
  ...
  'rules.oneHour': 'that stage’s first match kicks off',
  'rules.koTitle': 'Knockout rounds',
  'rules.koBody': 'When the knockout matchups are known, the teams are filled in automatically. Players can then make new selections for those fixtures until that round’s first match kicks off.',
...
const es: Dict = {
  ...
  'fx.changeHint': 'Puedes cambiar tu predicción hasta que empiece el primer partido de esta fase.',
  'fx.lockNote': 'Las predicciones se cierran cuando empieza el primer partido de esta fase.',
  ...
  'rules.oneHour': 'que empiece el primer partido de esa fase',
  'rules.koTitle': 'Rondas eliminatorias',
  'rules.koBody': 'Cuando se conocen los cruces eliminatorios, los equipos se completan automáticamente. Los jugadores pueden entonces hacer nuevas predicciones para esos partidos hasta que empiece el primer partido de esa ronda.',
